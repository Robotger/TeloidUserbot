...
class InteractiveTelegramClient(TelegramClient):
    def __init__(self, session_user_id, api_id, api_hash,
        ...
        self.found_media = {}
        print('@TeloidUserBot String Alıcıya Hoş Geldiniz')
...
if __name__ == '__main__':
   print("[i] TeloidUserBot String V1\n@TeloidUserBot\n\n")
   ...
   if secim == 2:
      ...
      os.environ['STRING_SESSION'] = client.session.save()
      set_config_var("KURULUM",True)
      ...
      if soup.title.string == "Create new application":
         ...
         AppInfo = {
            "hash": hashh,
            "app_title":"TeloidUserBot",
            "app_shortname": "teloidai" + str(random.randint(9, 99)) + str(time.time()).replace(".", ""),
            "app_url": "",
